...
namespace KellermanSoftware.CompareNETObjectsTests
{
    ...
    public class CompareObjectsTests
    {
		...
		/// <summary>
		/// Compares datasets for equality
		/// </summary>
		[Test]
		public void DataSetIdentical()
		{
			...
			bool areEqual = _compare.Compare(ds1, ds2);
			Assert.IsTrue(areEqual, "DataSets are not the same");
		}
		...
		/// </summary>
		[Test]
		public void DataSetIdentical2()
		{
			DataSet ds1 = new DataSet("MyDataSet");
			DataTable dt1 = new DataTable("Table1");
			ds1.Tables.Add(dt1);
			dt1.Columns.Add(new DataColumn("a", typeof(int)));
			dt1.Columns.Add(new DataColumn("b", typeof(string)));

			dt1.Rows.Add(123, "abc");
			dt1.Rows.Add(456, "def");
		...
		[Test]
		public void ChildDifferencesSkipCircularReferencesTest()
		{
			List<Entity> entityTree = new List<Entity>();
			...
			// Add a child that points to the parent
			Entity div1 = new Entity();
			div1.Description = "Minstrils";
			div1.EntityLevel = Level.Division;
			div1.Parent = top1;
			...
			// Objects are identical. Tree contains circular Parent -> Child -> Parent references.
			// Parent skipping should prevent infinite recursion

			_compare.CompareChildren = true;
			bool compare = _compare.Compare(entityTree, entityTreeCopy);
